...
\include{hoofdstuk_introductie}
\include{hoofdstuk_linux_hardware}
\include{hoofdstuk_installatie}
\include{hoofdstuk_systeem}
\include{hoofdstuk_inrichting}
\include{hoofdstuk_editors}
\include{hoofdstuk_user_management}
\include{hoofdstuk_proces_management}
\include{hoofdstuk_networking}
\include{hoofdstuk_xorg}
\include{hoofdstuk_device_files}
\include{hoofdstuk_basis_commando}
\include{hoofdstuk_shell}
\include{hoofdstuk_shell_scripting}
% Appendix:
\appendix
\include{appendix_virtualbox}
\include{appendix_bios}
\include{appendix_fdisk}
\include{appendix_grub}
\include{appendix_rescue}
\include{appendix_package}
\include{appendix_source}
\include{appendix_ssh}
\include{appendix_emacs}
\include{appendix_vim}

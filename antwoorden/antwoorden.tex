...
pdftitle={TIRLNX01 Antwoorden}, % title
...
% En antwoorden printen is nodig
\printanswers
% En punten
\addpoints
...
Omdat er geen tentamen word gegeven, zullen al deze vragen moeten worden ingeleverd bij de begeleidend docent. De begleidend docent zal instructie geven over hoe de vragen in te leveren. 
...
Het maximaal te behalen punten staat per vraag aangegeven en voor iedere week zijn maximaal 100 punten te behalen.
De berekening die resulteert in het eindcijfer word als volgt gedaan:
$$
\frac{behaalde\_punten}{\numpoints} \cdot 100 = eindcijfer
$$
Om een voldoende te halen zul je dus minimaal 385 punten moeten behalen.
...
\include{antwoorden_deel1}
\include{antwoorden_deel2}
\include{antwoorden_deel3}
\include{antwoorden_deel4}
\include{antwoorden_deel5}
\include{antwoorden_deel6}
\include{antwoorden_deel7}
